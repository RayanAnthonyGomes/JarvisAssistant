...
# Prompt jodi true hoy sheta prompt er 4 ta img banay tarpor false hoy
# false hoile program shesh

# 1. Important packages
# 2. Open Images = Open korbe Image
# 3. hugging face stable diffusion 
# 4. img 1,2,3,4 use jpg Korbve
# 5. loop:
#     bar bar read kore .data file Ta
#     status true hoile gen 
#     staus false hoile exit 
